...
--INSERT INTO My_accession VALUES ( 'qwe', 'Test Title #1', 'Looking started he up perhaps against. How remainder all additions get elsewhere resources. One missed shy wishes supply design answer formed. Prevent on present hastily passage an subject in be. Be happiness arranging so newspaper defective affection ye. Families blessing he in to no daughter.Families blessing he in to no daughter.Families blessing he in to no daughter.', 4, 10 , 1 )
...
INSERT INTO RequestJoinToAccession VALUES ( 'qqq', 'bla bla bla', 'Seo', 7, 'Waiting' );
INSERT INTO RequestJoinToAccession VALUES ( 'qqq', 'bla bla bla', 'Seo', 7, 'Rejected' );
INSERT INTO RequestJoinToAccession VALUES ( 'qqq', 'bla bla bla', 'Seo', 7, 'Accepted' );